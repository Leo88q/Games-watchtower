...
Разделы: Обзор, Игры, Аналитика, Безопасность, Контракты, Инвестор, Промпты, Деплой.
...
`GET /api/arena/prompts/:id`. Подробности — `docs/PRODUCT_GUIDE_RU.md`, деплой — `Dockerfile`.
