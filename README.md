...
Независимый аудит: `prompts/audit/PROMPT_AUDIT_INDEPENDENT.md` — промпт для другого AI-агента,
который проверяет работу на этом коммите и пишет отчёт с воспроизводимыми доказательствами
(18 проверяемых утверждений, обязательный формат отчёта, read-only).
