...
> **Обновление 2026-09-24:** сбор Ecosystem Share NFT ($100k) добавлен к пресейлу $WTWR ($250 000) как «Раунд 0»;
> общая цель — $350 000. Актуальные цифры — `token-landing/` (лендинг RU/EN, white paper, Часть K). Use of funds этого
> брифа заменён общей таблицей $350k; распределение прибыли: 25% NFT, 30% выкуп $WTWR, 15% разработчики, 30% казна.
