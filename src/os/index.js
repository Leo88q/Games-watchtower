  ...
  container.innerHTML = `
    <section class="panel" style="margin-top:24px;">
      ...
      <div style="margin-top:12px; padding:12px; background:#1a1a2e; border-radius:8px;">
        ...
        <div class="os-row">
          ${duplicates.map(d=>`<span class="os-badge warn">${esc(d.duplicate)} → best free ${esc(d.bestFree)} deprecated ${esc(d.deprecated)} category ${esc(d.category)}</span>`).join('')}
        </div>
        <div class="os-mono">${esc(JSON.stringify(v3Ideal.idealFreePerCategory || {}, null, 2).slice(0,1200))}</div>
      </div>
      ...
      <div class="os-grid">
        <div class="os-card">
          ...
          <div class="os-row">
            ${Object.entries(layers.identity?.providers || {}).map(([k,v])=>`<span class="os-badge ${v.configured?'ok':'warn'}">${esc(k)}: ${v.configured?'ok':'need env'}</span>`).join('')}
          </div>
          <div class="os-mono">${escJson(layers.identity?.onboardingFlow || [])}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(layers.assets?.strategies || layers.assets?.strategy || {}, null, 2).slice(0,600))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(layers.indexer?.strategy?.flow?.slice(0,3) || infra?.events || [], null, 2).slice(0,800))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${escJson(layers.l2?.routing || {})}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(gameSignals || layers.analytics?.gameSignals || {}, null, 2).slice(0,600))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(v2Products.engines || {}, null, 2).slice(0,800))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(v2Products.infra || infra?.idealFreeStack || {}, null, 2).slice(0,1000))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(gameSignals || {}, null, 2).slice(0,600))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(payments || v2Products.payments || {}, null, 2).slice(0,800))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(v2Products.aiAgents || ai?.idealFreeStack || {}, null, 2).slice(0,1000))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(v2Products.crossChain || crossChain || {}, null, 2).slice(0,800))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(v2Products.utils || utils || {}, null, 2).slice(0,600))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(security?.idealFreeStack || {}, null, 2).slice(0,1000))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(storage?.idealFreeStack || {}, null, 2).slice(0,1000))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(monetization?.idealFreeStack || {}, null, 2).slice(0,800))}</div>
        </div>
        ...
        <div class="os-card">
          ...
          <div class="os-mono">${esc(JSON.stringify(testing?.idealFreeStack || {}, null, 2).slice(0,800))}</div>
        </div>
